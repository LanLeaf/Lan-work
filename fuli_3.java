...
public class fuli_3 extends JFrame {
    ...
    private JComboBox getJComboBox0() {
        if (jComboBox0 == null) {
            ...
            jComboBox0.setModel(new DefaultComboBoxModel(new Object[] { "终值计算", "本金计算" ,"年限计算","利率计算"}));
    ...
    private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			jPanel1.add(getJButton4(), new Constraints(new Leading(121, 12, 12), new Leading(162, 10, 10)));
			jPanel1.add(getJTextField1(), new Constraints(new Leading(74, 168, 12, 12), new Leading(113, 12, 12)));
			jPanel1.add(getJTextField2(), new Constraints(new Leading(74, 168, 12, 12), new Leading(70, 12, 12)));
			jPanel1.add(getJTextField0(), new Constraints(new Leading(74, 168, 12, 12), new Leading(26, 12, 12)));
			jPanel1.add(getJTextField3(), new Constraints(new Leading(74, 164, 12, 12), new Leading(213, 12, 12)));
			jPanel1.add(getJLabel6(), new Constraints(new Leading(56, 12, 12), new Leading(215, 12, 12)));
			jPanel1.add(getJLabel2(), new Constraints(new Leading(14, 12, 12), new Leading(70, 12, 12)));
		}
		return jPanel1;
	}
    ...
    */
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                fuli_3 frame = new fuli_3();
                frame.setDefaultCloseOperation(fuli_3.EXIT_ON_CLOSE);
